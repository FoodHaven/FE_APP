...
RSpec.describe "Routes" do
  it "can find routes for market" do
    ...
    id = 2212
    stub_request(:get, "https://foodhaven-be.onrender.com/api/v1/markets/#{id}/transit_routes?original_lat=#{original_lat}&original_lon=#{original_lon}&destination_lat=#{destination_lat}&destination_lon=#{destination_lon}").to_return(status: 200, body: json_response)
